...
import com.learn.booklistapp.databinding.FragmentFreeBooksCategoryBinding;

import java.net.URL;
import java.util.ArrayList;


public class FreeBooksCategory extends Fragment {


    public FreeBooksCategory() {
        // Required empty public constructor
    }


    FragmentFreeBooksCategoryBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFreeBooksCategoryBinding.inflate(getLayoutInflater());

        Json_Link = getActivity().getIntent().getStringExtra("Category");
        Json_Link +="&filter=free-ebooks&maxResults=20&startIndex=";
        tempLink = Json_Link;
        Json_Link += limit;
        ...
        binding.nestedScrollViewFree.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            @Override
